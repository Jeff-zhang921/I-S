...
test("routes from verification into profile visibility and commitment without government ID upload", async ({
  page,
}) => {
  ...
  await expect(
    page.getByRole("heading", { name: /Choose where this account is active/i }),
  ).toBeVisible();
  ...
  await page
    .getByRole("radio", { name: /Hidden Until You Reach Out/i })
    .click();
  await page
